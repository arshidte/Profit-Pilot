...
export const UsersIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.969A3 3 0 0 0 9 15.189m-3.75 0a3 3 0 0 0-4.682-2.72A9.094 9.094 0 0 0 6 18.72m-3 0a9 9 0 0 0 18 0a9 9 0 0 0-18 0ZM12 12.75h.008v.008H12v-.008ZM12 15a2.25 2.25 0 0 1-2.25-2.25A2.25 2.25 0 0 1 12 10.5a2.25 2.25 0 0 1 2.25 2.25A2.25 2.25 0 0 1 12 15Z" />
    </svg>
);
