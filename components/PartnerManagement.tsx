  ...
  return (
      ...
      <div className="p-4 bg-slate-50 dark:bg-dark-background rounded-xl">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 items-end gap-2">
            ...
            <button type="submit" className="w-full px-3 py-2 text-white bg-primary hover:bg-primary-hover dark:bg-primary-dark dark:hover:bg-primary-dark-hover rounded-lg shadow-sm flex items-center justify-center sm:text-sm font-medium">
          ...
          <div className="p-6">
            ...
            <div className="mt-4">
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 bg-input dark:bg-dark-input border border-border dark:border-dark-border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary sm:text-sm text-text-primary dark:text-dark-text-primary"
                min="0.01"
                step="0.01"
    ...
    {partnerToDelete && (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-card dark:bg-dark-card rounded-2xl shadow-xl w-full max-w-sm border border-border dark:border-dark-border">
          <div className="p-6">
            <h3 className="text-lg font-bold text-center text-text-primary dark:text-dark-text-primary">Delete {partnerToDelete.name}?</h3>
            <p className="text-sm text-text-secondary dark:text-dark-text-secondary mt-2 text-center">
              Are you sure you want to delete this partner? Their settlements will be removed and they will be unassigned from all sales. This action cannot be undone.
            </p>
            <div className="mt-6 flex gap-3">
              <button
